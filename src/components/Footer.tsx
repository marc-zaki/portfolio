    ...
    <footer className="w-full py-8 border-t border-white/10 mt-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-sm text-foreground/60 text-center">
          © {currentYear} Marc Zaki.
        </p>

        <div className="flex items-center gap-4">
          <a href="https://github.com/marc-zaki" target="_blank" rel="noreferrer" className="text-foreground/60 hover:text-primary transition-colors">
            <FaGithub className="h-5 w-5" />
            <span className="sr-only">GitHub</span>
          </a>
          <a href="https://www.linkedin.com/in/marc-zakii/" target="_blank" rel="noreferrer" className="text-foreground/60 hover:text-primary transition-colors">
